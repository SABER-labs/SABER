...
from utils.config import max_audio_length_in_secs, sampling_rate, max_label_length, min_audio_length_in_secs, lmdb_airtel_payments_root_path
...
if __name__ == '__main__':
    lmdb_root_path = lmdb_airtel_payments_root_path
    commonvoice_dataset_root = "/tts_data/asrdata/testset-backup-paymentbank-validation"
    # commonvoice_dataset_root = "~/AirtelDEV/VoiceDataForAirtel/testset-backup-paymentbank-validation"
    language_codes = ["en"]
