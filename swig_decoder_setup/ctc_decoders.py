...
class Scorer(swig_decoders.Scorer):
    ...
    def __init__(self, alpha, beta, model_path, sentencepiece_path, vocabulary):
        swig_decoders.Scorer.__init__(self, alpha, beta, model_path, sentencepiece_path, vocabulary)
...
def ctc_beam_search_decoder(probs_seq,
    ...
    beam_results = swig_decoders.ctc_beam_search_decoder(
        probs_seq, vocabulary, beam_size, cutoff_prob, cutoff_top_n,
        ext_scoring_func)
